...
def Prepdata(num_trainB,num_trainM,num_testB,num_testM,xdata_B,xdata_M,nB,nM,dB):
    ...
    index_1=np.random.choice(range(num_trainB+num_testB), num_trainB, replace=False)
    index_2=np.random.choice(range(num_trainM+num_testM), num_trainM, replace=False)
    #Train Test seperate
...
xtrain,ytrain,xtest,ytest = Prepdata(num_train,num_train,num_test,num_test,xdata_B,xdata_M,nB,nM,dB)
#save data
...
xtrain,ytrain,xtest,ytest = Prepdata(num_trainB,num_trainM,num_testB,num_testM,xdata_B,xdata_M,nB,nM,dB)
#save data
